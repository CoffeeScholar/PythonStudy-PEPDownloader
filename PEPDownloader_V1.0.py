...
def merge_images_to_pdf(directory, filename):
    # 获取目录名作为 PDF 文件名
...
def downloadBookImages(folder_name, base_url, bookName):
    # 创建文件夹
...
bookName = "小学英语（三年级起）六年级上"
folder_name = bookName
base_url = "https://book.pep.com.cn/" + bookId + "/files/mobile/"

# 下载书的图片
downloadBookImages(folder_name, base_url, bookName)

# 合并为 PDF 文件
merge_images_to_pdf(folder_name, bookName)